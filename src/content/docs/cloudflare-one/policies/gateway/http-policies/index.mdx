...
The Redirect action allows you to redirect matched HTTP requests to a different specified URL.

#### Send policy context

When you turn on **Send policy context**, Gateway will include context.

#### Preserve original URL and query string
