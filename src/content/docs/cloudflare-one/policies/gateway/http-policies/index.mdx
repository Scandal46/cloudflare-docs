...
| --------------------- | ------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| User email            | Email of the user that made the query.                                                                        | `&user_email=user@example.com`                             |
...
| Connection ID         | ID of the proxy connection for which the redirect took effect.                                                | `&connection_id=ddcd6361-d5e5-4fdd-9bb3-c3a2de286860`      |
| Request ID            | ID of the HTTP request for which the redirect took effect.                                                    | `&request_id=ddcd6361-d5e5-4fdd-9bb3-c3a2de286860`         |
